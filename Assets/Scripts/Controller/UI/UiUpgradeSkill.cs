...
public class UiUpgradeSkill : MonoBehaviour
{
    ...
    public void SetUpData(SkillData skillData, SaveGameTierLevel saveGameTierLevel)
    {
        ...
        {
            txtDes.text = Language.GetKey("Des1_" + skillData.SkillID);
        ...
        else
        {
            ...
            if (skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes != null)
            {
                ...
                if (skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes.Count == 2)
                {
                    txtDes.text = string.Format(Language.GetKey("Des1_" + skillData.SkillID), skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes[0].Value[Level - 1], skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes[1].Value[Level - 1]);
                }
                if (skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes.Count == 3)
                {
                    txtDes.text = string.Format(Language.GetKey("Des1_" + skillData.SkillID), skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes[0].Value[Level - 1], skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes[1].Value[Level - 1], skillData.baseSkills[saveGameTierLevel.Tier - 1].SkillAttributes[2].Value[Level - 1]);
                }
            }
        }
