...
//public  class ParticleExtensions
//{
//    /// Add Extension to the native ParticleSystem class.
//    /// eg:  myParticleSystem.Scale(2); 
//    public void Scale(this ParticleSystem particles, float scale, bool includeChildren = true)
//    {
//        ParticleScaler.Scale(particles, scale, includeChildren);
//    }

//    public void ScaleByTransform(this ParticleSystem particles, float scale, bool includeChildren = true)
//    {
...
{
    public ParticleScalerOptions defaultOptions = new ParticleScalerOptions();

    public void ScaleByTransform(ParticleSystem particles, float scale, bool includeChildren = true)
    {
    ...
    public void Scale(ParticleSystem particles, float scale, bool includeChildren = true, ParticleScalerOptions options = null)
    {
    ...
    private void ScaleSystem(ParticleSystem particles, float scale, bool scalePosition, ParticleScalerOptions options = null)
    {
    ...
    //private ParticleSystem.MinMaxCurve ScaleMinMaxCurve(ParticleSystem.MinMaxCurve curve, float scale)
    //{
    ...
    private void ScaleCurve(AnimationCurve curve, float scale)
    {
